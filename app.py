...
import forms
import json 
from models import db, connect_db, Msg, User, Comic, Offer, Comics_offers
...
def editcomic(id):
    ...
    if comic.owner_id == current_user: 
        ...
        if form.validate_on_submit(): 
            ...
            comic.issue_num = form.issuenumber.data
            ...
            flash(f"Comic details updated for { comic.title } # {comic.issue_num } ")
